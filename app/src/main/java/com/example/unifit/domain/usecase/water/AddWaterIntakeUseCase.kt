...
class AddWaterIntakeUseCase(private val repository: WaterIntakeRepository) {
    suspend operator fun invoke(water: WaterIntake): Long = repository.insertWaterIntake(water)
}